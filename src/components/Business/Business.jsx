  ...
  return (
    ...
    <div id="business">
      ...
      <div className="Iron Ore Fines">
        <Link to="/product/iron-ore-fines">
      ...
      <div className="Iron Ore Pellet">
        <Link to="/product/iron-ore-pellet">
          <img src={iop} alt="iop" />
        </Link>
        {/* <p className="des">
      ...
      <div className="Silico Manganese">
        <Link to="/product/silico-manganese">
